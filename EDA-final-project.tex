...
quality. Changes in conductivity over time suggest a potential salt and
mineral pollutants entering the system.

For this study, we will analyze how specific conductance can vary
depending on the season. In particular, we will address the impact of
...
\emph{Neuse River water quality and discharge data at Kinston, North
...
To determine whether specific conductance varies seasonally, we first
decomposed a time series analysis.
...
The time series decomposition of specific conductivity shows a seasonal
component in the Neuse River (Figure 4). After removing the seasonal
component of the time series, a seasonal MannKendall test shows that the
trend over time generally exhibits stationarity (p-value = 0.25276)
(Table 2), meaning that specific conductivity is neither increasing or
