...
```{r Histograms}
ggplot(NeuseWQ_processed, aes(x = SpC_uS.cm)) +
  geom_histogram(binwidth = 5) +
  labs(title = "Distribution of Specific Conductance in the Neuse River",
       x = expression("Specific Conductance ("*mu*"S/cm)"), y= "Count")

ggplot(NeuseFlow_processed, aes(x = discharge_cfs)) +
  geom_histogram(binwidth = 20) +
  labs(title = "Distribution of Flow in the Neuse River",
       x = "Discharge (cfs)", y = "Count")
