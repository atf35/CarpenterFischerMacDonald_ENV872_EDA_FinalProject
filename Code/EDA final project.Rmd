...
The Neuse River at Kinston does not show strong seasonal trends in salinity. Specific conductance, the proxy used to examine salinity, showed marginal seasonal trends when examined using both a time series decomposition and when plotted for the day of the year. Sodium appears to have the strongest correlation with specific conductance, indicating that it perhaps is the main driver of the salinity that does exist in the Neuse River. Magnesium and calcium had a much lower correlation, showing that they do not influence the overall salinity as much as sodium. Overall, this is good news for the Neuse, indicating that at Kinston, which is relatively far down the watershed, upstream uses of salts do not cause seasonal changes in the river. 
