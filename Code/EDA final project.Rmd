...
```{r Plot by minerals by specific conductance, include=TRUE, echo=FALSE, message=FALSE, fig.align='center', fig.width=6, fig.height=4, fig.cap="Salts by Specific Conductivity over the Year."}
