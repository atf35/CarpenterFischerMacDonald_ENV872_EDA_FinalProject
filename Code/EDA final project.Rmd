...
```{r Visualize 2013-2021 WQ data (Conductance), echo=FALSE, fig.align='left', fig.cap="Specific Conductance in the Neuse River from 2013 through 2021."}
...
```{r Water Quality Dataset Summary, echo=FALSE}
...
```{r Discharge summary, echo=FALSE}
summary(NeuseFlow_processed) #no NAs in the dataset
```

```{r Discharge over time, echo=FALSE, fig.align='left', fig.cap="Discharge in the Neuse River from 2013 through 2021."}
...
```{r Plot of Conductivity Time Series Decomp, echo=FALSE, fig.align='left', fig.cap="Time Series Decomposition of Conductivity in the Neuse River."}
...
```{r Plot of Calcium Time Series Decomp, echo=FALSE, fig.align='left', fig.cap="Time Series Decomposition of Calcium in the Neuse River."}
plot(NeuseCond_Calcium_decomp, main = "Calcium")
```

```{r Plot of Magnesium Time Series Decomp, echo=FALSE, fig.align='left', fig.cap="Time Series Decomposition of Magnesium in the Neuse River."}
plot(NeuseCond_magneisum_decomp, main = "Magnesium")
```

```{r Plot of Sodium Time Series Decomp, echo=FALSE, fig.align='left', fig.cap="Time Series Decomposition of Sodium in the Neuse River."}
...
```{r Plot of Discharge Time Series Decomposition, echo=FALSE, fig.align='left', fig.cap="Time Series Decomposition of Discharge in the Neuse River."}
plot(NeuseFlow_decomp)
```

```{r Testing for Seasonality, echo=FALSE}
#Conductivity
...
```{r Visualize 2013-2021 Conductivity, echo=FALSE, fig.align='left', fig.cap="Conductivity in the Neuse River from 2013 through 2021."}
...
```{r Visualise all three components together, echo=FALSE, fig.align='left', fig.cap="Calcium, Magnesium, and Sodium in the Neuse River from 2013 through 2021"}
...
```{r Visualise salts and conductivity, echo=FALSE, fig.align='left', fig.cap="Specific Conductivity and salts in the Neuse River from 2013 through 2021"}
